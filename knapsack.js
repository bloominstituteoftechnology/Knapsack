...
//   console.log(knapsackIterative(items, capacity)) //actual code at bottom
...
// console.log(greedy()); //uncomment this for code to work
...
// console.log(knapsackIterative(items, capacity))
console.log(memoizedKnapsack(items, capacity))